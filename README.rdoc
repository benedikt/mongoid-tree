= mongoid-tree {<img src="https://secure.travis-ci.org/benedikt/mongoid-tree.png" />}[http://travis-ci.org/benedikt/mongoid-tree] {<img src="https://gemnasium.com/benedikt/mongoid-tree.png" />}[http://gemnasium.com/benedikt/mongoid-tree]
...
mongoid-tree is on {Travis}[http://travis-ci.org/benedikt/mongoid-tree] running the specs on Ruby 1.8.7, Ruby 1.9.2, Ruby 1.9.3, JRuby, Rubinius and Ruby Enterprise Edition.
...
{<img src='http://www.pledgie.com/campaigns/12137.png?skin_name=chrome' />}[http://www.pledgie.com/campaigns/12137]

{<img src="https://api.flattr.com/button/flattr-badge-large.png" />}[https://flattr.com/submit/auto?user_id=benediktdeicke&url=https://github.com/benedikt/mongoid-tree&title=mongoid-tree&language=&tags=github&category=software]
